var sourceCode=`/* ==UserStyle==
@name         Smart - Luogu
@version      20220702.08.18
...
/*图片背景*/
html > body {
    background-image: url(https://cdn.luogu.com.cn/upload/image_hosting/01g3ojbo.png) !important;
...
.selected {
    color:#fff !important;
    background-color:#bb73e7fa !important;
...
.am-comment-main{
    ...
    opacity:.85;
    box-shadow:0px 0px 10px #828282bd;
...
/*
div[data-v-0a593618]:after {
    content: url(https://cdn.luogu.com.cn/upload/image_hosting/dx6bxop7.png);
}
*/
/*记录详情 */
.wrapper > .test-case {
...
/*背景*/
html > body {
    background-image: url(https://cdn.luogu.com.cn/upload/image_hosting/qny3ycfb.png) !important;
    background-repeat: no-repeat;
    background-size: cover;
    background-position: center;
    background-attachment: fixed;
